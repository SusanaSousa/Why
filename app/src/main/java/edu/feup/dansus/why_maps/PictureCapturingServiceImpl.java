...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void takePicture() throws CameraAccessException {
        ...
        // captureBuilder.set(CaptureRequest.SENSOR_FRAME_DURATION, Long.valueOf(22000));
        // captureBuilder.set(CaptureRequest.SENSOR_SENSITIVITY, 3200); // ISO value
        // captureBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, Long.valueOf(100000));
